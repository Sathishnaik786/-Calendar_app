...
function UserPage() {
  ...
  }, []); // Removed refreshCount as it is not directly used inside the function

  useEffect(() => {
    fetchCommunications();
  }, [fetchCommunications, refreshCount]); // Added refreshCount here for re-fetching on refreshCount change
